...
export class AbonnementService {
  ...
  public getAbonnement(idReceiver: number): Observable<Abonnement> {
    return this.http
      .get<Abonnement>(
        `${this.baseUrl}/get/${idReceiver}&${this.authService.getUsername()}`
      )
      .pipe(
        catchError((e) => {
  ...
  public unfollowUser(idFollowership: number): Observable<any> {
    return this.http
      .delete<any>(`${this.baseUrl}/delete/${idFollowership}`)
      .pipe(
        catchError((e) => {
          this.catchErrorService.showErrorModal(e);
          return throwError(() => e);
  ...
  public getFollowersQuantity(idUser: number): Observable<number> {
    return this.http
      .get<number>(`${this.baseUrl}/get/followers-count/${idUser}`)
      .pipe(
        catchError((e) => {
          this.catchErrorService.showErrorModal(e);
          return throwError(() => e);
  ...
  public getFollowingQuantity(idUser: number): Observable<number> {
    return this.http
      .get<number>(`${this.baseUrl}/get/following-count/${idUser}`)
      .pipe(
        catchError((e) => {
          this.catchErrorService.showErrorModal(e);
          return throwError(() => e);
